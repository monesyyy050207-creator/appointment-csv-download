...
> Design notes for **appointment-csv-download** — a runnable java example that Spring service that exports appointment workflow rows and returns a signed CSV download link.
...
- **Feature code** — the actual task: appointment-csv-download.
